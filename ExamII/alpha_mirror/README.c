Assignment name : alpha_mirror Expected files : alpha_mirror.c Allowed functions: write
...
Examples:
>./alphamirror"abc"zyx&gt;./alpha_mirror "My horse is Amazing." | cat -e Nb slihv rh Znzarmt.$ >./alphamirror|cat−e$>
